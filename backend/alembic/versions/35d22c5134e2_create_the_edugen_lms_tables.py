...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "char_length(username) >= 3", name="ck_users_username_length"
        ),
        sa.ForeignKeyConstraint(
            ["created_by"],
            ["users.id"],
    ...
    op.create_table(
        "categories",
        sa.Column(
            "id", sa.UUID(), nullable=False, comment="Primary key of the category."
        ),
        sa.Column(
            "name",
            sa.String(length=100),
    ...
    op.create_table(
        "courses",
        sa.Column(
            "id", sa.UUID(), nullable=False, comment="Primary key of the course."
        ),
        sa.Column(
            "title",
            sa.String(length=255),
    ...
    op.create_table(
        "certificates",
        sa.Column(
            "id", sa.UUID(), nullable=False, comment="Primary key of the certificate."
        ),
        sa.Column(
            "student_id",
            sa.UUID(),
        ...
        sa.UniqueConstraint(
            "certificate_number", name="uq_certificates_certificate_number"
        ),
        sa.UniqueConstraint(
            "student_id", "course_id", name="uq_certificates_student_course"
        ),
    ...
    op.create_index(
        "ix_certificates_issued_at", "certificates", ["issued_at"], unique=False
    )
    op.create_index(
        "ix_certificates_student_id", "certificates", ["student_id"], unique=False
    )
    op.create_table(
        "course_reviews",
        sa.Column(
            "id", sa.UUID(), nullable=False, comment="Primary key of the review."
        ),
        sa.Column(
            "course_id", sa.UUID(), nullable=False, comment="Course being reviewed."
        ),
        sa.Column(
            "student_id",
            sa.UUID(),
        ...
        sa.UniqueConstraint(
            "course_id", "student_id", name="uq_course_reviews_course_student"
        ),
    )
    op.create_table(
        "enrollments",
        sa.Column(
            "id", sa.UUID(), nullable=False, comment="Primary key of the enrollment."
        ),
        sa.Column(
            "student_id",
            sa.UUID(),
        ...
        sa.Column(
            "status",
            sa.Enum("ACTIVE", "COMPLETED", name="enrollment_status_enum"),
            nullable=False,
    ...
    op.create_table(
        "modules",
        sa.Column(
            "id", sa.UUID(), nullable=False, comment="Primary key of the module."
        ),
        sa.Column(
            "title", sa.String(length=255), nullable=False, comment="Module title."
        ),
        sa.Column(
            "description", sa.Text(), nullable=True, comment="Module description."
        ),
        sa.Column(
            "course_id",
            sa.UUID(),
    ...
    op.create_table(
        "payments",
        sa.Column(
            "id", sa.UUID(), nullable=False, comment="Primary key of the payment."
        ),
        sa.Column(
            "student_id",
            sa.UUID(),
    ...
    op.create_table(
        "lessons",
        sa.Column(
            "id", sa.UUID(), nullable=False, comment="Primary key of the lesson."
        ),
        sa.Column(
            "title", sa.String(length=255), nullable=False, comment="Lesson title."
        ),
        sa.Column(
            "description", sa.Text(), nullable=True, comment="Lesson description."
        ),
        sa.Column(
            "video_url",
            sa.String(length=500),
    ...
    op.create_index(
        "ix_lessons_module_active", "lessons", ["module_id", "is_active"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "title", sa.String(length=255), nullable=False, comment="Quiz title."
        ),
        ...
        sa.Column(
            "duration", sa.Integer(), nullable=True, comment="Quiz duration in minutes."
        ),
        sa.Column(
            "is_active",
            sa.Boolean(),
        ...
        sa.Column(
            "created_by", sa.UUID(), nullable=True, comment="User who created the quiz."
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
        ...
        sa.CheckConstraint(
            "pass_marks <= total_marks", name="ck_quizzes_pass_marks_valid"
        ),
    ...
    op.create_table(
        "quiz_attempts",
        sa.Column(
            "id", sa.UUID(), nullable=False, comment="Primary key of the quiz attempt."
        ),
        sa.Column(
            "quiz_id",
            sa.UUID(),
        ...
        sa.Column(
            "status",
            sa.Enum(
                "IN_PROGRESS", "COMPLETED", "ABANDONED", name="quiz_attempt_status_enum"
            ),
            nullable=False,
    ...
    op.create_index(
        "ix_quiz_attempts_quiz_id", "quiz_attempts", ["quiz_id"], unique=False
    )
    op.create_table(
        "quiz_questions",
        sa.Column(
            "id", sa.UUID(), nullable=False, comment="Primary key of the quiz question."
        ),
        sa.Column(
            "quiz_id",
            sa.UUID(),
        ...
        sa.Column(
            "option_a", sa.String(length=255), nullable=True, comment="Option A."
        ),
        sa.Column(
            "option_b", sa.String(length=255), nullable=True, comment="Option B."
        ),
        sa.Column(
            "option_c", sa.String(length=255), nullable=True, comment="Option C."
        ),
        sa.Column(
            "option_d", sa.String(length=255), nullable=True, comment="Option D."
        ),
        sa.Column(
            "correct_option",
            sa.CHAR(length=1),
    ...
    op.create_table(
        "quiz_answers",
        sa.Column(
            "id", sa.UUID(), nullable=False, comment="Primary key of the quiz answer."
        ),
        sa.Column(
            "attempt_id",
            sa.UUID(),
        ...
        sa.CheckConstraint(
            "marks_obtained >= 0", name="ck_quiz_answers_marks_positive"
        ),
        sa.ForeignKeyConstraint(
            ["attempt_id"],
            ["quiz_attempts.id"],
